...
class AppConstants {
    static var baseURL = "http://134.209.157.211/Carrykoro/public/api/"
    // status User Default key
    static var otpVerificationID = "otpVerificationID"
    static var accountStatus = "accountStatus"
    
    //Login  User Default Key
